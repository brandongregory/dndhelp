...
Summoners are an iconic role in a lot of fiction. Characters like Lucy Heartfilia from _Fairy Tail_, Yuna from _Final Fantasy X_, or even your favorite Pokemon trainer show how powerful summoner characters can be, and it’s a prominent power fantasy that’s hard to imagine as anything else. Can it be effective in DnD? With the right build and considerations, yes!
...
While most of these are Conjuration spells, a few are Necromancy spells. These are, by the loosest definition of the word, summoning spells, but they require certain _raw materials_ that the Conjuration spells don’t and may not fit some character concepts. Do what you want with this information.
...
Clerics make amazing [support](/5e-build-guides/support-caster-builds/) characters and can keep their summoned creatures alive, but they have few other summoner-related class features.
